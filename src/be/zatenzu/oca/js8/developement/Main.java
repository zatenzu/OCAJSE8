...
public class Main{
  ...
  /*
    ...
    Compile the class and create be/zatenzu/oca/js8/development/Main.class file in the current directory
  ...
  */
  ...
  /** multiple classes in one file -> multiple .class file after compile **/
  ...
  //java -cp "c:/tmp/myjar/*" be.zatenzu.oca.js8.developement.Main
