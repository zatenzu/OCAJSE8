...
public class TernaryOperator{
   ...
   * - Widening can is applied on second and third
  ...
  public static void main(String[] args){
    int i = true ? (byte)0 : new Integer(0);//auto unboxing and widening
    Integer integer = true ? 0 : 1;//auto boxing
    i = false ? 0 : null;//auto boxing of null value(null -> Integer = OK but when null Integer is unboxed to int  -> NPE)
